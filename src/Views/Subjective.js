                        ...
                        <div className='container container-card-size info-bg pt-4 pb-4'>
                            ...
                            <div>
                                <CardsTest
                                    ...
                                    howLong={encounter.subjetive ? encounter.subjetive.gastroIntestinal.abdominalPain.howLongHaveYouHadAbdominalPain : ''}
                                    whereIs={encounter.subjetive ? encounter.subjetive.gastroIntestinal.abdominalPain.whereIsYourAbdominalPainLocated : ''}
                                    painLocation={encounter.subjetive ? encounter.subjetive.gastroIntestinal.abdominalPain.doesThePainRadiateOfMoveToAnotherLocation : ''}
                                    painAppear={encounter.subjetive ? encounter.subjetive.gastroIntestinal.abdominalPain.DidYourAbdominalPainStartAllOfASuddenOrDidItComeOnSlowly : ''}
                                    eatingPain={encounter.subjetive ? encounter.subjetive.gastroIntestinal.abdominalPain.DoesYourAbdominalPainOccurAfterEating : ''}
                                />
                            </div>
